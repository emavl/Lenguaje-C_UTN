 ...
 * \brief -> Crea y retorna un nuevo LinkedList. Es el constructor, ya
	que en él crearemos la estructura y daremos valores iniciales a los campos.
 *
 * \return
 */
 ...
 * \param nodeIndex index int Indice del nodo a obtener.
 ...
 *
 * \param this this LinkedList* Puntero a la lista
